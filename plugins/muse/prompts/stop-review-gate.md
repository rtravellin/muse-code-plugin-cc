...
For example, the output of /muse:check or /muse:runs does not count.
...
<grounding_rules>
This run is read-only: you can read files in the repository but you have no shell.
Ground every blocking claim in the repository files you inspected during this run.
